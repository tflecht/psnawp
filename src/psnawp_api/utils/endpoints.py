BASE_PATH = {
    ...
    "legacy_profile_uri": "https://us-prof.np.community.playstation.com/userProfile/v1/users",
    "gaming_lounge": "https://m.np.playstation.com/api/gamingLoungeGroups/v1",
    "group_messaging": "https://us-gmsg.np.community.playstation.com/groupMessaging/v1",
